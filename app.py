            ...
            for i in range(5):
                if player['battlefield'][i] is None:
                    ...
                    if deployment_traps:
                        ...
                        # Collect ALL enemy units deployed AFTER this trap was placed
                        available_targets = []
                        for idx, unit_id in enumerate(player['battlefield']):
                            if unit_id is not None:
                                unit_deployed_turn = player['battlefield_deployed_turn'][idx]
                                # Only include units deployed AFTER the trap was placed
                                if unit_deployed_turn > trap_placed_turn:
                        ...
                        self.pending_trap_trigger = {
                            ...
                            'trigger_data': {
                                'deployed_player': player_idx,
                                'available_targets': available_targets  # Units deployed after trap was placed
                            },
