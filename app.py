    ...
    def ai_turn(self):
        ...
        if self.phase == 'deploy':
            ...
            for item in playable_cards:
                ...
                if result.get('deployment_trap_trigger') or result.get('field_trap_trigger') or result.get('technique_trap_trigger'):
                    # Human's trap triggered during AI's play
                    # Store the trap trigger for frontend to handle
                    # Don't continue playing more cards - let trap resolve first
