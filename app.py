...
class GameState:
    ...
    def resolve_trap_effect(self, trap_id, trap_owner, trigger_data=None):
        ...
        # ============================================
            ...
            # Redirect attack to another unit (requires target selection)
            # For now, mark that target selection is needed
            result['needs_target_selection'] = True
            result['target_type'] = 'redirect_attack'
            result['attack_cancelled'] = True  # Temporarily cancel until target chosen
            result['messages'].append("Choose a new target for the attack!")
            self.log("Decoy Protocol activated - redirecting attack")
