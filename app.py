...
class GameState:
    ...
    def get_state(self, player_perspective=0):
        ...
        return {
            ...
            'you': {
                ...
                'battlefield': [
                    self.get_card_data(cid, self.players[player_perspective]['battlefield_exhausted'][i]) 
                    if cid else None 
            ...
            'opponent': {
                ...
                'battlefield': [
                    self.get_card_data(cid, self.players[opponent]['battlefield_exhausted'][i]) 
                    if cid else None 
    ...
    def get_card_data(self, card_id, is_exhausted=False):
