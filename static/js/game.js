...
function showTrapActivationPrompt(trap, triggerMessage) {
    ...
    // Button handlers
    document.getElementById('trap-activate-yes').addEventListener('click', () => {
        document.body.removeChild(modal);
        // TODO: Phase 3B - Send activation to backend
        addLog(`✅ Activated: ${trap.name}`);
    });
    
    document.getElementById('trap-activate-no').addEventListener('click', () => {
        document.body.removeChild(modal);
